...
export default function About() {
  return (
    <section id="about" aria-labelledby="about-heading" className="py-20 bg-bg relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 id="about-heading" className="font-display font-bold text-display text-text-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="p-8 rounded-2xl bg-white border border-[rgba(26,26,26,0.10)] shadow-card">
              <div className="divide-y divide-gray-100">
                {PILLARS.map((pillar, i) => (
                  ...
                  >
                    ...
                    <div>
                      <span className="font-sans text-xs font-semibold uppercase tracking-widest text-accent block mb-1.5">
                        {pillar.label}
                      </span>
